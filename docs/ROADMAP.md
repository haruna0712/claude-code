...
| Phase 0.5   | 最小 stg デプロイ（Hello World 相当）                           | 5〜7 日 + 手動 0.5 日 | 14〜15 日   | ✅ **完了** (16/16、stg apply + NS 委任 + ACM + HTTPS まで本番稼働)                                                           |
| Phase 1     | 認証・プロフィール・基本ツイート (+ F-02/F-10/F-11/F-14 前倒し) | 14〜18 日 (+2 日)     | 32〜34 日   | ✅ **完了** (23/23 Issue + F1-1〜F1-7 セキュリティ修正)                                                                       |
| **Phase 2** | **TL・リアクション・フォロー・検索 (+ F-15 pg_bigm migration)** | 14〜18 日             | 50〜52 日   | 🚧 **進行中** (backend P2-02〜P2-10 完了、frontend P2-13 再投入中 (PR feature/issue-186)、P2-14〜P2-19 + 検索 P2-01/11/12 残) |
...
- [ ] ホーム TL（アルゴリズム / フォロー中タブ） ← P2-13 #186
- [ ] リアクション UI（10 種、キーボード代替 Alt+Enter 対応） ← P2-14 #187
- [ ] RT / 引用 RT / リプライ UI ← P2-15 #188
- [ ] 検索画面 ← P2-16 (別セッション)
- [ ] トレンドタグ / おすすめユーザーサイドバー ← P2-17 #189
- [ ] 「もっと見る」展開（X 準拠） ← P2-18 #190
- [ ] 未ログイン用 `/explore` ← P2-19 #191
