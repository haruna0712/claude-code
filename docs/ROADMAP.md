...
- [x] 既読・タイピング表示正常
- [x] S3 プリサインド URL 経由で画像・ファイル送信成功 (2026-05-07 stg E2E 検証: presign POST 200 → S3 multipart 204 → confirm 201 → WS send_message id=56 + attachment id=1 → test3 側で受信 + CloudFront 経由 GET 200 で 459927 bytes 完全一致)
