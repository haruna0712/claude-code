...
- 残 follow-up: Ctrl+V クリップボード paste で画像を直接添付できるようにする ← #470 (open)
- 残 follow-up: handle autocomplete (user search endpoint なし) / room メンバー一覧表示 / 招待取消 (DELETE 未実装) — 必要になったら別 Issue で起票
